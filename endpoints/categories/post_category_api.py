...
class PostCategoryAPI(BaseAPI):
    def __init__(self):
        super().__init__()
        self.url = self.base_url + '/categories/'
        self.headers = {}

    @allure.step('Send POST request to create a new category')
    def post_category(self, category_data, token=None):
            ...
            try:
                ...
                if self.json:
                    ...
                    if self.status_code == 401:
                        ...
                        self.expected_response_data = {
                            'detail': 'Создавать категории могут '
